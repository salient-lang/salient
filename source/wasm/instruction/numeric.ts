...
const f32abs      = new NumericInstruction(0x99);
const f32neg      = new NumericInstruction(0x9A);
const f32ceil     = new NumericInstruction(0x9B);
const f32floor    = new NumericInstruction(0x9C);
const f32trunc    = new NumericInstruction(0x9D);
const f32nearest  = new NumericInstruction(0x9E);
const f32sqrt     = new NumericInstruction(0x9F);
const f32add      = new NumericInstruction(0xA0);
const f32sub      = new NumericInstruction(0xA1);
const f32mul      = new NumericInstruction(0xA2);
const f32div      = new NumericInstruction(0xA3);
const f32min      = new NumericInstruction(0xA4);
const f32max      = new NumericInstruction(0xA5);
const f32copysign = new NumericInstruction(0xA6);

const f64abs      = new NumericInstruction(0xA7);
const f64neg      = new NumericInstruction(0xA8);
const f64ceil     = new NumericInstruction(0xA9);
const f64floor    = new NumericInstruction(0xAA);
const f64trunc    = new NumericInstruction(0xAB);
const f64nearest  = new NumericInstruction(0xAC);
const f64sqrt     = new NumericInstruction(0xAD);
const f64add      = new NumericInstruction(0xAE);
const f64sub      = new NumericInstruction(0xAF);
const f64mul      = new NumericInstruction(0xB0);
const f64div      = new NumericInstruction(0xB1);
const f64min      = new NumericInstruction(0xB2);
const f64max      = new NumericInstruction(0xB3);
const f64copysign = new NumericInstruction(0xB4);
