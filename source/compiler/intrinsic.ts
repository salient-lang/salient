...
export const i64 = new Intrinsic("i64", Types.Intrinsic.i32, 8);
export const f32 = new Intrinsic("f32", Types.Intrinsic.i32, 4);
export const f64 = new Intrinsic("f64", Types.Intrinsic.i32, 8);